...
public class Constructor {
	...
	//생성자보다 먼저 호출된다 
	{
		System.out.println("초기화 블록 호출 전에 memverStr에 담겨있는 값 : " + memberStr);
	...
	static {
		System.out.println("초기화 블록 호출 전에 classInt에 담겨 있는 값 : " + classInt);
		classInt = 100;
	}
	
	//생성자 : 클래스가 인스턴스화 될 때 호출되는 메서드 
	//		 필드변수를 초기화하는 용도로 사용된다 
	...
	public Constructor() {
		...
		System.out.println("생성자가 호출되기 전 memberStr에 담겨 있는 값 : " + memberStr);
		memberStr = "pclass";
	}
	
	public Constructor(String name) {
		System.out.println("Constructor클래스의 매개변수 입니다");
