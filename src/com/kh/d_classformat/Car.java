...
//접근제한자 : public(어떤 패키지에서도 가능) , default(같은 패키지에서만 가능)
//예약어 : abstarct, final
public class Car {
	...
	//			필드변수 : 필드에 선언한 변수(속성)
	//				인스턴스변수 : 필드변수 중 일반변수를 뜻함(static변수가 아닌 변수) 
	//				클래스변수 : 필드변수 중 static변수 
	...
	//규칙 : 매개변수의 타입이나 개수가 달라야한다 
	
	
	//캡슐화 
	//필드변수의 접근제한자를 private으로 지정해 외부에서의 직접적인 접근을 막고 
	//getter/setter 메서드를 통해서만 필드변수에 접근을 하도로고 하는 것 
