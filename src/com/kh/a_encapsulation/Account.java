...
// 접근제한자 : public(어디서나 사용가능), default(현 패키지에서만 사용가능)
// 예약어 : abstract, final
...
public class Account {
	...
	//2. 캡슐화 
	// 클래스 내부의 필드변수에 클래스 바깥에서 접근하는 것을 막는 것
	// getter / setter 메서드를 통해 접근하도록 제한 
	// 필드변수의 접근제한자를 private 로 지정 
	private String name; //이름 
	private int balance; // 잔액 
	
	//setter메서드 :(용도) 캡슐화된 클래스의 필드변수에 값을 대입하기 위해 사용하는 메서드 
